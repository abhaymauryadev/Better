export default function HomePage() {
    return (
      <>
       <div className='bg-[#014e36] h-full w-full '>
      <div className='flex justify-center '>
        <h1 className='font-bold leading-heading m-0 p-0 w-auto tracking-tight 
        md:tracking-tighter mt-[48px] z-1 leading-small text-center text-[50px] text-white md:mt-[80px]
         md:p-0 md:text-4xl lg:text-[100px]'>The first <br />
        <span className='bg-[linear-gradient(116deg,_#00FF80_16.51%,_#A987FF_54.85%,_#EA06FF_94.62%)] bg-clip-text text-transparent'>AI-powered</span>Mortgage</h1>
      </div>

      <p className="font-normal leading-body m-0 p-0 text-white text-[18px] md:text-[24px] 
      text-center mt-[32px] md:mt-[18px]">Our tech unlocks lower rates, higher chances of approval
      ,<br/>and a lightning‑fast process from approval
      &nbsp; 
      to&nbsp;closing. Over $100 billion funded.
      </p>

      <div className="w-auto text-center mt-8 md:mt-10">
        <a className="inline-flex  items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 bg-green-600 text-black hover:bg-[#004733]
        hover:text-white h-16 px-12 py-5 w-full sm:w-fit" href="/start">Start my pre-approval</a>
        <div className="mt-3 flex items-center justify-center gap-1 text-xs text-accentSecondary">
          <svg width="20"  height="20"  viewBox="0 0 16 17" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 6H8.5V10.5H7.5V6ZM6.5 1.5H9.5V2.5H6.5V1.5Z" className="fill-accentSecondary"></path><path className="fill-accentSecondary" d="M13.9987 5.00055L13.2887 4.29555L12.1637 5.42055C11.2429 4.35706 9.94762 3.68926 8.54717 3.5559C7.14671 3.42254 5.74872 3.83386 4.64365 4.70442C3.53857 5.57497 2.81139 6.83782 2.61318 8.23057C2.41497 9.62333 2.76098 11.0389 3.57931 12.1832C4.39765 13.3275 5.62539 14.1125 7.00745 14.3751C8.3895 14.6377 9.81961 14.3578 11.0006 13.5934C12.1817 12.8291 13.0228 11.6391 13.3493 10.2707C13.6758 8.90233 13.4625 7.46077 12.7537 6.24554L13.9987 5.00055ZM7.99875 13.5005C7.10873 13.5005 6.2387 13.2366 5.49868 12.7422C4.75866 12.2477 4.18189 11.5449 3.84129 10.7226C3.5007 9.90035 3.41158 8.99555 3.58522 8.12264C3.75885 7.24972 4.18743 6.4479 4.81677 5.81856C5.44611 5.18923 6.24793 4.76064 7.12084 4.58701C7.99376 4.41338 8.89856 4.50249 9.72082 4.84309C10.5431 5.18368 11.2459 5.76046 11.7404 6.50048C12.2348 7.2405 12.4987 8.11053 12.4987 9.00055C12.4987 10.194 12.0246 11.3386 11.1807 12.1825C10.3368 13.0264 9.19222 13.5005 7.99875 13.5005Z"></path>
          </svg><span className="mr-1 text-white">3 min</span>
          <span className=" text-white">| No hard credit check </span>
        </div>
      </div>
  ...
  <section className="section m-auto flex max-w-screen-2xl flex-col justify-between gap-x-3xl p-base px-lg py-4xl md:px-10 md:flex-row-reverse xl:p-[120px]">
    <div className="flex flex-col justify-center md:max-w-[507px]">
        ...
        <h2 className="font-bold text-textPrimary leading-heading m-0 p-0 w-auto tracking-tight md:tracking-tighter mb-lg text-3xl leading-small md:text-3xl lg:text-[88px]">Find out why we’re better.</h2>

        <a className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out
         duration-200 bg-[#004733] text-white hover:bg-[#017848] h-16 px-12 py-5 mb-sm w-full md:w-fit mb-8" href="/b/our-stories">See all our stories</a>

        <div className="mb-2xl flex items-center justify-center gap-5 leading-small text-gray-600 md:justify-start">
    ...
    <div className="flex flex-col gap-lg md:flex-col-reverse ">
        ...
        <div className="flex gap-6 overflow-scroll [&::-webkit-scrollbar]:hidden mt-9 items-center">
          <button className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 border-[5px] border-[#017848] text-[#017848] h-12 px-6 py-3 w-auto">Paul</button>

          <button className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 border-2 border-gray-300 text-gray-700 hover:border-[#017848] hover:text-[#017848] hover:border-[5px] h-12 px-6 py-3 w-auto">Amanda</button>

          <button className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 border-2 border-gray-300 text-gray-700 hover:border-[#017848] hover:text-[#017848] hover:border-[5px] h-12 px-6 py-3 w-auto">Tiara</button>
    ...
    <div className="relative flex justify-center overflow-hidden rounded-lg w-[341px] h-[606px]">
      <button className="relative w-full h-full" aria-label="Play video for Paul">
        ...
        <img alt="Paul-thumbnail" loading="lazy" decoding="async" data-nimg="fill" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', objectFit: 'cover', color: 'transparent' }} src="https://media.better.com/better-com/homepage/social-proof/still-quote-Paul.webp"/>
  ...
  <section className="section w-full pb-base lg:pb-12">
      ...
      <div className="flex w-full max-w-lg flex-wrap gap-12 lg:gap-6 lg:max-w-none lg:items-center lg:justify-between">
          <h2 className="font-bold text-gray-900 leading-heading m-0 p-0 w-full max-w-lg text-3xl md:text-4xl tracking-tight">Got questions?<br/>We've got answers</h2>

      <div className="flex gap-3 overflow-x-scroll lg:gap-6 [&::-webkit-scrollbar]:w-0 [&::-webkit-scrollbar]:h-0">
        <button className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 border-[5px] border-[#017848] text-[#017848] h-12 px-6 py-3 w-auto">Our products</button>

        <button className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 border-2 border-gray-300 text-gray-700 hover:border-[5px] hover:border-[#017848] hover:text-[#017848] h-12 px-6 py-3 w-auto">Calculators</button>

        <button className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 border-2 border-gray-300 text-gray-700 hover:border-[5px] hover:border-[#017848] hover:text-[#017848] h-12 px-6 py-3 w-auto">Guides &amp;FAQs</button>

      </div>
    </div>

    <div className="flex flex-row flex-wrap justify-center gap-8 lg:gap-6">
      <a className="flex w-full max-w-lg cursor-pointer flex-col gap-8 rounded-base bg-successBackground px-6 py-5 md:flex-row md:[&amp;&gt;img]:h-[100%] md:[&amp;&gt;img]:max-w-[285px] md:gap-10 md:max-w-full md:justify-between md:px-12 md:py-8 lg:flex-1 lg:flex-col lg:basis-1/4 lg:justify-between lg:gap-6 lg:px-12 lg:py-[35px] lg:max-w-lg lg:[&amp;&gt;img]:max-w-none lg:[&amp;:nth-child(2)&gt;*]:flex-1 lg:[&amp;:nth-child(2)&gt;img]:h-[100%] lg:[&amp;:nth-child(2)&gt;img]:max-w-[285px] lg:[&amp;:nth-child(2)]:max-w-none lg:[&amp;:nth-child(2)]:basis-3/5 lg:[&amp;:nth-child(2)]:flex-row lg:[&amp;:nth-child(2)]:gap-10 lg:[&amp;:nth-child(3)&gt;*]:flex-1 lg:[&amp;:nth-child(3)&gt;img]:h-[100%] lg:[&amp;:nth-child(3)&gt;img]:max-w-[285px] lg:[&amp;:nth-child(3)]:max-w-none lg:[&amp;:nth-child(3)]:basis-3/5 lg:[&amp;:nth-child(3)]:flex-row-reverse lg:[&amp;:nth-child(3)]:gap-10" href="/content/ai-mortgage-lending">

      <div className="flex flex-col gap-6">
      <h4 className="font-bold leading-heading m-0 p-0 w-auto md:text-2xl text-xl md:tracking-normal tracking-normal text-backgroundInversePrimary lg:text-xl">How AI Mortgage Lending is Transforming the Home Loan Process</h4>
  ...
  <img alt="Woman on cellphone, seeing how AI is making the mortgage process easier and faster" rel="preconnect" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" className="w-full rounded-base object-cover h-[160px] md:h-[130px]" style={{ color: 'transparent' }} src="https://media.better.com/better-com/homepage/learning-center/ai-mortgage.webp"/></a>
  ...
  <img alt="One day mortgage" rel="preconnect" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" className="w-full rounded-base object-cover h-[160px] md:h-[130px]" style={{ color: 'transparent' }} src="https://media.better.com/better-com/homepage/learning-center/one-day-mortgage.webp"/></a>
...
<img alt="Better HELOC" rel="preconnect" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" className="w-full rounded-base object-cover h-[160px] md:h-[130px]" style={{ color: 'transparent' }} src="https://media.better.com/better-com/homepage/learning-center/better-heloc.webp"/></a>
...
<img alt="Insurance" rel="preconnect" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" className="w-full rounded-base object-cover h-[160px] md:h-[130px]" style={{ color: 'transparent' }} src="https://media.better.com/better-com/homepage/learning-center/insurance.webp"/></a>
    </div>
   </div>
  </section>
